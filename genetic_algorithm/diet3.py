...
def fitness(individual):
    ...
    value = min (diffProtein, diffCarb, diffFat)
    
    diffProtein = abs(1 - (1. * protein_sum / protein_reference))
    diffCarb = abs(1 - (1. * carb_sum / carb_reference))
    diffFat = abs(1 - (1. * fat_sum / fat_reference))
    
    value2 = min (diffProtein, diffCarb, diffFat)
    
    print value, value2
    
    return min (diffProtein, diffCarb, diffFat),
